...
class RecipeListTableViewController: UITableViewController, RecipeAddDelegate, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
		...
		let entity = NSEntityDescription.entity(forEntityName: "Recipe", in: self.managedObjectContext)
	...
	*/
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		...
		if segue.identifier == kShowRecipeSegueID {
			...
			// Add a Recipe
			let newRecipe = NSEntityDescription.insertNewObject(forEntityName: "Recipe", into: self.managedObjectContext) as! Recipe
