...
class AppController: NSObject {
	...
	override func awakeFromNib() {
		...
		var color = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1).cgColor
		...
		color = UIColor(red: 0.8, green: 0.8, blue: 0.8, alpha: 1).cgColor
