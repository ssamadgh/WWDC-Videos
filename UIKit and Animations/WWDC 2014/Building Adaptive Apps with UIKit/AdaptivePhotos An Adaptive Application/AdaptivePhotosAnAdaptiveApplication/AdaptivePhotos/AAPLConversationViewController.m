...
@interface AAPLConversationViewController ()
...
static NSString * const AAPLConversationViewControllerCellIdentifier = @"Cell";
...
{
    return [self.conversation.photos objectAtIndex:indexPath.row];
}
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:AAPLConversationViewControllerCellIdentifier forIndexPath:indexPath];
    return cell;
}
