...
private class GroupChatController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        {
            let redAttribute: [NSAttributedString.Key: AnyObject] = [
                NSAttributedString.Key.backgroundColor: #colorLiteral(red: 0.9859465361, green: 0, blue: 0.04060116783, alpha: 0.4969499144)
            ]
