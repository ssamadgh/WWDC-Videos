...
class AAPLOverlayTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
	...
	func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
		...
		if let sourceVC = source as? AAPLRootViewController, sourceVC.presentationShouldBeAwesome {
			return AAPLCoolPresentationController(presentedViewController: presented, presenting: presenting)
		}
		else {
			return AAPLOverlayPresentationController(presentedViewController: presented, presenting: presenting)
		}
	}
